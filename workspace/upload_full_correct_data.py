...
# Reading the final corrected CSV
rows = []
csv_path = '/home/mohit/workspace/final_meta_data_05_07.csv'
...
if resp.status_code != 200:
    ...
    print(f"Successfully uploaded {len(rows)} rows with FULL corrected data (including University Admit and 12% gap).")
