...
OUTPUT_PATH = os.path.join(WORKSPACE, "Degreefyd_Final_Master_White.html")
LABEL       = "ONLINE"
...
# Handle merged headers: Online sheet row 1 has duplicate "Campaign" / lowercase "lead_LMS".
