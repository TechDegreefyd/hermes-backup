...
for entry in data:
    ...
    missing_data.append({
        ...
        "LMS Leads": 0 # Placeholder for distribution
    })

df = pd.DataFrame(missing_data)
df.to_csv("meta_may3_missing_account.csv", index=False)
print(f"Fetched {len(df)} ads for University_Admit_01 on May 3.")
